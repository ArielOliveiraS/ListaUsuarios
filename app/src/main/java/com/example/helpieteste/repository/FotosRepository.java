...
import com.example.helpieteste.model.FotosResposta;
...
public class FotosRepository {
    ...
    public Observable<FotosResposta> obterListaFotos(Context context){
        ...
        try {
            ...
            InputStream inputStream = manager.open("fotos.json");
             ...
             */
            FotosResposta resposta = gson.fromJson(reader, FotosResposta.class);
